package flutter.mishatronic.file_opener;
 ...
 * OpenFilePlugin
 */
public class FileOpenerPlugin implements MethodCallHandler
    ...
    private FileOpenerPlugin(Context context, Activity activity) {
